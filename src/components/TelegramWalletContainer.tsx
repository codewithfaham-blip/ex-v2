    ...
    <div className="bg-zinc-900/40 border border-zinc-800/50 p-6 md:p-8 rounded-[2.5rem] relative overflow-hidden group transition-all hover:border-blue-600/30">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-sm font-black uppercase tracking-widest italic text-white">Telegram Gateway</h3>
        </div>
        ...
        {!address ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-zinc-950/80 border border-zinc-900 rounded-xl p-4">
               <p className="text-[9px] text-zinc-600 uppercase font-black mb-1">Active Wallet Hash</p>
               <p className="text-[11px] font-mono text-zinc-400 break-all">{address}</p>
            </div>
            <div className="flex items-center gap-2 text-zinc-600 text-[10px] font-bold italic">
               <ShieldCheck size={12} />
               <span>Linked to your secure terminal session</span>
            </div>
            <button 
              onClick={() => tonConnectUI.disconnect()}
              className="text-zinc-500 hover:text-red-500 transition text-[9px] font-black uppercase tracking-[0.2em] pt-2"
            >
              Detach Wallet
            </button>
          </div>
